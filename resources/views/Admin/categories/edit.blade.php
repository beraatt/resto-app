        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method='POST' action='{{ route('admin.categories.edit',$category->id) }}'  enctype="multipart/form-data"> @method('PUT')
                        @csrf
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit"
                                class="px-4 py-2 bg-indigo-400 hover:bg-indigo-600 text-white rounded-lg">Güncelle</button>
